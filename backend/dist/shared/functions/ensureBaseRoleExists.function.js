...
exports.ensureBaseRoleExists = void 0;
...
const ensureBaseRoleExists = () => __awaiter(void 0, void 0, void 0, function* () {
    let thisRole = yield roleRepo.findOne({
        where: {
            name: main_roles_enum_1.MAIN_ROLES_ENUM.BASE_USER,
        },
    });
    if (!thisRole) {
...
exports.ensureBaseRoleExists = ensureBaseRoleExists;
